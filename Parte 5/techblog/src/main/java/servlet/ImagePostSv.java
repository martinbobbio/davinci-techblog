...
@WebServlet(urlPatterns="/imagepost/*")
public class ImagePostSv extends HttpServlet {
	private static final long serialVersionUID = 1251001105853430500L;
	
	@Inject
	private ImagePostController imgCtnrl;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try{
			ImagePost img = imgCtnrl.findByPath(path);
